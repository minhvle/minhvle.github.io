...
3. Critically compare the design constructs of object-oriented model and relational model design;
...
8. Use data modeling and database development tools effectively.